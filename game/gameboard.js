...
board.prototype.dropper = function(gl, shader, canvas){
	...
	switch(piece) {
		case 0:  //creates square
					...
					for(var x = 0; x < 4; x++){
						this.size[activeShapeArr[x][0]][activeShapeArr[x][1]]   = -1;
					}
		...
		case 1: //creates lefttZ
					...
					for(var x = 0; x < 4; x++){
						this.size[activeShapeArr[x][0]][activeShapeArr[x][1]]   = -2;
					}
		...
		case 2: //creates rightZ
					...
					for(var x = 0; x < 4; x++){
						this.size[activeShapeArr[x][0]][activeShapeArr[x][1]]   = -3;
					}
		...
		case 3://creates line
					...
					for(var x = 0; x < 4; x++){
						this.size[activeShapeArr[x][0]][activeShapeArr[x][1]]   = -4;
					}
		...
		case 4:// creates rgihtL
					...
					for(var x = 0; x < 4; x++){
						this.size[activeShapeArr[x][0]][activeShapeArr[x][1]]   = -5;
					}
		...
		case 5:// creates leftL
					...
					for(var x = 0; x < 4; x++){
						this.size[activeShapeArr[x][0]][activeShapeArr[x][1]]   = -6;
					}
		...
		case 6://creates upsideT 
					...
					for(var x = 0; x < 4; x++){
						this.size[activeShapeArr[x][0]][activeShapeArr[x][1]]   = -7;
					}
